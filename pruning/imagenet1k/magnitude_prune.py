...
def magnitude_prune(
    ...
    torch.save(
        ...
        f"pruned_magnitude_resnet18_{density:.2f}_{iterative_steps}_iter_ft{epochs}epoch.pth",
    )
    save_prune_summary(
        report,
        path=f"magnitude_prune_report_{density:.2f}_{iterative_steps}_iter_ft{epochs}epoch.json",
    )
    return report
